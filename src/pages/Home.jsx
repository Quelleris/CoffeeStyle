			...
			<section className='blog section' id='blog' aria-label='blog'>
				<div className='container'>
					<div className='title-wrapper flex flex-jc-sb flex-ai-c'>
						...
						<Link to='/blog' className='btn-link flex flex-ai-c'>
							<span>View All</span>
							<ion-icon
								name='arrow-forward'
								aria-hidden='true'
							...
							<div className='blog-card'>
								...
								<div className='card-content'>
									...
									<p className='blog-description'>
										...
										adipisicing elit. Laborum voluptates
										quisquam explicabo voluptas dolorem
										quibusdam assumenda excepturi.
									</p>
									<time
										datetime='2022-12-18'
						...
						<li>
							<div className='blog-card'>
								...
								<div className='card-content'>
									<h3 className='blog-title'>
										<a href='#' className='card-title'>
											How long does a cup of coffee keep
											you awake?
										</a>
									</h3>
									<p className='blog-description'>
						...
						<li>
							<div className='blog-card'>
								...
								<div className='card-content'>
									<h3 className='blog-title'>
										<a href='#' className='card-title'>
											Research suggests that heavy coffee
											drinkers may reap health benefits
										</a>
									</h3>
									<p className='blog-description'>
										Lorem, ipsum dolor sit amet consectetur
